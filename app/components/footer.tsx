      ...
      <ul className="font-sm mt-8 flex flex-col space-x-0 space-y-2 text-neutral-600 md:flex-row md:space-x-4 md:space-y-0">
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://github.com/Adam-Omarali"
          >
            <ArrowIcon />
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://www.youtube.com/@adamomarali"
          >
            <ArrowIcon />
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://calendly.com/adamomarali"
          >
            <ArrowIcon />
            <p className="ml-2 h-7">chat</p>
          </a>
        </li>
      </ul>
    </footer>
